...
const zh: Dict = {
  ...
  'search.tip': '在这里搜索任务：输入名称就能跳转，打开任务还能查看它的前置 / 后续依赖。',
  'hint.close': '知道了',
  'search.clear': '清空搜索内容',
  'search.filtered': '筛选外',
  'search.recent': '最近查看',
  ...
  'panel.done': '已完成',
  'panel.ctaTip': '点这里追踪这个任务：打开它的前置依赖链，并记录完成进度。',
...
const en: Dict = {
  ...
  'search.tip': 'Search quests here: type a name to jump to it, and open a quest to see what it depends on.',
  'hint.close': 'Got it',
  ...
  'panel.done': 'Finished',
  'panel.ctaTip': 'Click here to follow this quest: open its prerequisite chain, and keep track of progress.',
...
const ja: Dict = {
  ...
  'search.tip': 'ここでクエストを検索できます。名前を入力するとジャンプし、開くと前提・後続の依存も確認できます。',
  'hint.close': '了解',
  ...
  'panel.done': '完了済み',
  'panel.ctaTip': 'ここをクリックすると、このクエストの前提依存チェーンを開き、進捗も記録できます。',
